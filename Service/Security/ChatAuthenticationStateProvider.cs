...
public class ChatAuthenticationStateProvider : AuthenticationStateProvider
{
    ...
    public override async Task<AuthenticationState> GetAuthenticationStateAsync()
    {
        ...
        if (currentUser != null && currentUser.Data != null && !string.IsNullOrEmpty(currentUser.Data.EmailAddress)) 
        { 
             //create a claims
             var claimUserName= new Claim(ClaimTypes.Name, currentUser.Data.UserName!);
            var claimEmailAddress = new Claim(ClaimTypes.Email, currentUser.Data.EmailAddress);
